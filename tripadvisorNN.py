...
def parse_line(line):
    ...
    tf.Print(input_=d, data=[d], message="dictionary")
...
Hotelname = tf.feature_column.indicator_column(tf.feature_column.categorical_column_with_identity("Hotelname",22))
